...
import { attachAuthResponse, checkExistingUser, checkExistingUserByID, createSafeUserResponse, createUserWithOtp, sendVerificationEmail, } from "../services/auth.service.js";
...
export const verifyUserEmailOtp = async (req, res, next) => {
    try {
        ...
        if (!user)
            return sendError(res, 400, "Invalid request. User not found.");
