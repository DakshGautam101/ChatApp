...
export default function SignUpPage() {
    ...
    const [errors, setErrors] = useState<UserInterface>({} as UserInterface);
    ...
    const setField = (field: string) => (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (errors[field as keyof UserInterface]) setErrors((prev) => ({ ...prev, [field]: undefined }));
    };
                        ...
                        <CardContent>
                            <form className="space-y-5" onSubmit={handleSubmit} noValidate>
                                <div className="space-y-4">
                                    <div className="space-y-1.5 stagger-item" style={{ "--stagger-index": 1 } as React.CSSProperties}>
                                    ...
                                    <div className="space-y-1.5 stagger-item" style={{ "--stagger-index": 2 } as React.CSSProperties}>
                                    ...
                                    <div className="space-y-1.5 stagger-item" style={{ "--stagger-index": 3 }as React.CSSProperties}>
                                    ...
                                    <div className="space-y-2 stagger-item" style={{ "--stagger-index": 4 }as React.CSSProperties}>
