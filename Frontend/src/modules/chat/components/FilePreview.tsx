...
import type { item } from "../stores/useFileStore";

export interface FilePreviewProps {
    item: item;
    onImageClick?: (clickedItem: item) => void;
    onRetry?: (item: item) => void;
    onCancel?: (id: string) => void;
    onCaptionChange?: (id: string, caption: string) => void;
}

export function FilePreview({ item, onImageClick, onRetry, onCancel, onCaptionChange }: FilePreviewProps) {
