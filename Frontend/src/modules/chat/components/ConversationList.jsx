...
const ConversationList = () => {
    ...
    return (
        <div className="flex flex-col h-full animate-fade-in">
            ...
            {!isLoadingConversations && !validConversations.length && (
            ...
            {!isLoadingConversations && validConversations.length > 0 && (
                <div className="flex flex-col p-2 space-y-1 overflow-y-auto flex-1">
                    {validConversations.map((conversation, idx) => {
                        ...
                        const isActive = (activeConversation?._id?.toString() || activeConversation?._id) === (conversation._id?.toString() || conversation._id);
                        const title = isGroup
